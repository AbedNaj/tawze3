             ...
             @forelse ($inventories as $index => $item)
                 <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
                     ...
                     <div class="grid grid-cols-3 gap-4">
                         <div>
                             <label
                                 class="block text-xs font-medium text-gray-500 mb-1">{{ __('product.locationable_name') }}</label>
                             <div class="text-sm font-medium">{{ $item->locationable->name ?? '' }}</div>
                         </div>
                         <div>
                             <label
