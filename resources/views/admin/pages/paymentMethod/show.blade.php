        ...
        <div x-show="!editing">
            <div class="bg-white p-6 rounded-lg shadow relative">
                ...
                <div class="absolute top-4 left-4">
                    <form action="{{ route('admin.paymentMethods.delete', [$PaymentMethod->id]) }}" method="post">
                        @csrf
                        @method('DELETE')
                ...
                <dl class="space-y-2">
                    <x-admin.read-only-field :label="__('sale.payment_method.name')" :value="$PaymentMethod->name" />
                </dl>
        ...
        <div x-show="editing" x-cloak>
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                ...
                <form action="{{ route('admin.paymentMethods.update', [$PaymentMethod->id]) }}" method="POST"
                    ...
                    <x-admin.form.input name="name" :label="__('sale.payment_method.name')" :value="$PaymentMethod->name" />
