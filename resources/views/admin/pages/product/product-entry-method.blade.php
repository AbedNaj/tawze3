    ...
    <div x-data="{ withQR: false, QrScan: false }">
        ...
        <div x-show="withQR" x-cloak>
            <x-admin.form.template :title="__('product.choose_qr_method')">
                <section class="space-y-6 justify-center items-center flex flex-col">
                    ...
                    <x-admin.buttons.default click="startBarcodeScanner()">
                    ...
                    <x-admin.buttons.default click="withQR = false; stopBarcodeScanner()">
                        {{ __('product.go_back') }}
                    </x-admin.buttons.default>
        ...
        <div x-show="QrScan" x-cloak>
            <x-admin.form.template :title="__('product.scan_with_external')">
                <section class="space-y-6 justify-center items-center flex flex-col">
                    <form method="get" action="{{ route('admin.products.create') }}" class="space-y-6 w-full max-w-md">
                        <x-admin.form.input name="qr_code" label="{{ __('product.scan_please') }}"
                            autofocus></x-admin.form.input>
